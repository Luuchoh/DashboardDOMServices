...
const Dashboard = () => {
  ...
  const name = users.find(user => user._id === service.user);
    ...
    <>
          ...
          <CCard>
            ...
            <CCardBody>
              ...
              <div className="w-50">
                ...
                <p>Ocupacion: {user.occupation ? user.occupation:'Por definir'}</p>
                <p>Telefono: {user.phone ? user.phone:'Por definir'}</p>
      ...
      <CRow>
        <CCol xs="12" sm="12" md="12">
          <CCard>
            <CCardHeader>
              Último Servicio Agregado
            </CCardHeader>
            <CCardBody>
              <div className="d-flex align-items-center">
              <div className="w-50">
                <p>Servicio: {service.title}</p>
                <p>Descripcion: {service.description}</p>
                <p>Locacion: {service.location}</p>
